...
- Width: `If(sideCollapsed, 64, 220)`, Height: `Parent.Height`
- Fill: `theme.Surface`
- BorderColor: `theme.Border`, BorderThickness: `0`, with a right border via
  a 1-px rectangle pinned at `X: Self.Width - 1`.
...
| Control | Name | Properties |
|---------|------|------------|
| Rectangle (left accent) | `recRailAccent` | X: `0`, Y: `0`, Width: `3`, Height: `Parent.TemplateHeight`, Fill: `If(ThisItem.Key = LookUp(Table({K:"scrHome",V:"Home"},{K:"scrList",V:"List"},{K:"scrDetail",V:"List"},{K:"scrNew",V:"New"}), K = App.ActiveScreen.Name, V), theme.Maroon, Transparent)` |
| Icon | `icnRailItem` | X: `14`, Y: `12`, Width: `16`, Height: `16`, Icon: `Switch(ThisItem.Key, "Home", Icon.Home, "List", Icon.DockCheckProperties, "New", Icon.Add)`, Color: `theme.Ink2` |
| Label | `lblRailItem` | X: `40`, Y: `0`, Width: `Parent.TemplateWidth - 80`, Height: `Parent.TemplateHeight`, Text: `ThisItem.Label`, Color: `theme.Ink2`, Size: `12`, VerticalAlign: `Center`, Visible: `!sideCollapsed` |
| Label (count badge) | `lblRailCount` | X: `Parent.TemplateWidth - 36`, Y: `12`, Width: `28`, Height: `16`, Text: `Text(ThisItem.Count)`, Color: `theme.Ink4`, Size: `10`, Align: `Center`, Visible: `!sideCollapsed && !IsBlank(ThisItem.Count)`, Fill: `RGBA(240,240,240,1)` |
